                                        ...
                                        <div class="form_cont">
                                            ...
                                            <form method="POST" action="{{ route('session_sa.upload_u2s') }}" class=""> 
                                                ...
                                                <div class="form-group row" > 
                                                        ...
                                                        <input id="email" type="email" class=" @error('email') is-invalid @enderror regTxtBox" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="enter your email address here">
                                                ...
                                                <div class="form-group row">
                                                    <!--<label for="password">{{ __('messages.admin_form_pwd') }}</label>-->
                                                        <input id="password" type="password" class=" @error('password') is-invalid @enderror regTxtBox" name="password" required autocomplete="current-password" placeholder="enter your password here">
