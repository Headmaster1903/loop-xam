...
<body>
    <div style="z-index: -1;">
        <div class="fixedOeverlayBG" style="background-color: #121212;"></div>
        <div class="">
            <br>
                            ...
                            <div class="col-md-12" >
                                <div style="">                        
                                    <div class="">
                                        ...
                                        <div class="form_cont">
                                            <h3 class="colhd" style="font-family: "Raleway", sans-serif;"><i class="fa fa-key"></i> Login</h3>
...
unset($__errorArgs, $__bag); ?> regTxtBox" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="enter your email address here">
...
unset($__errorArgs, $__bag); ?> regTxtBox" name="password" required autocomplete="current-password" placeholder="enter your password here">
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u160536160/domains/mine-pool.io/public_html/core/resources/views/auth/login.blade.php ENDPATH**/ ?>