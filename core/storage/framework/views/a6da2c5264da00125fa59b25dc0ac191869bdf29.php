		...
		<div class="card full-height">
            ...
            <a href="#">
  						...
  						<div class="border_btm">
  							...
  							<h4 class="fw-bold text-uppercase text-success op-8">SIGNUP BONUS</h4>
  							<h3 class="fw-bold"><?php echo e($settings->currency); ?> 100</h3>
  							<div class="colhd margin_n10" >&emsp;</div>	
  							<br>	
  						</div>
						</a>
			...
			<!--END OF OVERALL STATISTICS CARD-->
		</div>
	</div>
			...
			<div class="card-body">
				...
				<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
					...
					<div class="px-2 pb-2 pb-md-0 text-center">
						...
						<h6 class="fw-bold mt-3 mb-0">Total Referals</h6>
					</div>
				</div>
			</div>
			<!--END OF BALANCE CARD-->
...
<div id="ref_wd" class="container popmsgContainer" >
  ...
  </div><?php /**PATH /home/u160536160/domains/mine-pool.io/public_html/core/resources/views/user/atlantis/overview.blade.php ENDPATH**/ ?>