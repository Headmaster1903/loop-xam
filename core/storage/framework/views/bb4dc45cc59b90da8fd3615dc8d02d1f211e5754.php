                ...
                <div class="row">
                       <div class="col-sm-12 card">
                          ...
                          <ul class="nav nav-tabs mt-5" id="myTab" role="tablist">
                            ...
                            <!--</li>-->
                            <li class="nav-item">
                              <a class="nav-link" id="wallet-tab" data-toggle="pill" href="#wallet" role="tab" aria-controls="wallet" aria-selected="false">Add Wallets</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="p-5 tab-pane fade " id="wallet" role="tabpanel" >
                              <div class="row form-group">
                                <div class="col-sm-12">
                                  <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"><?php echo e(__('Add Dogecoin Wallet Address')); ?></div>
                                    </div>
                                    <div class="card-body">
                                        <form class="" method="post" action="/user/add/btc_wallet">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label><?php echo e(__('Wallet Provider')); ?></label>
                                                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                        <input type="text" class="form-control" name="coin_host" required placeholder="Exp. Blockchain, Coinbase, Paxful, Binance, Trustwallet etc.">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label><?php echo e(__('Wallet Address')); ?></label>
                                                        <input type="text" class="form-control" name="coin_wallet"  required placeholder="DLHDyhh6yr6t3r6b182jpzbNEyXb3C361 ">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <button class="collcc btn btn-info"><?php echo e(__('Add Wallet')); ?></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                       ...
                                       <table id="basic-datatables" class="display table table-striped table-hover" >
                                            <thead>
                                                <tr>                                                
                                                    ...
                                                    <th><?php echo e(__('Wallet Provider')); ?></th>
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u160536160/domains/mine-pool.io/public_html/core/resources/views/user/profile.blade.php ENDPATH**/ ?>