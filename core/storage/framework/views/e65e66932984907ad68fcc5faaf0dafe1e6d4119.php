...
<body>
    <div class="row">
        ...
        <div class="col-sm-4" style="border:1px solid #CCC; padding:4%; box-shadow:2px 2px 4px 4px #CCC;">
        	...
        	<p>
        	   <?php echo e(__('messages.wd_this_to_not')); ?> <b><?php echo e($md['username']); ?></b> <?php echo e(__('messages.has_made_wd')); ?> <?php echo e(env('APP_URL')); ?>
...
</html><?php /**PATH /home/u160536160/domains/mine-pool.io/public_html/core/resources/views/mail/admin_wd_notification.blade.php ENDPATH**/ ?>